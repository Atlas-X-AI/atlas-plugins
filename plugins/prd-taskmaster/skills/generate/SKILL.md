...
1. Call `mcp__plugin_prd_taskmaster_prd_taskmaster__check_gate(target_phase="GENERATE")`.
...
**MCP (preferred)**: `mcp__plugin_prd_taskmaster_prd_taskmaster__load_template(type="comprehensive")`
...
**MCP (preferred)**: `mcp__plugin_prd_taskmaster_prd_taskmaster__validate_prd(input_path=".taskmaster/docs/prd.md")`
...
**MCP**: `mcp__plugin_prd_taskmaster_prd_taskmaster__calc_tasks(requirements_count=<count>)`
...
**MCP fallback**: `mcp__plugin_prd_taskmaster_prd_taskmaster__tm_parse_prd(input_path=".taskmaster/docs/prd.md", num_tasks=<recommended>)`
...
**MCP fallback**: `mcp__plugin_prd_taskmaster_prd_taskmaster__tm_analyze_complexity` (wraps the CLI)
...
1. Call `mcp__plugin_prd_taskmaster_prd_taskmaster__advance_phase(next_phase="HANDOFF")`.
