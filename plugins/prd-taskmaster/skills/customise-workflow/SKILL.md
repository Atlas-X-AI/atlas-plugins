...
description: >-
  Customise the @atlas-ai/prd-taskmaster plugin workflow via curated brainstorm
...
AI-driven workflow customisation for the `@atlas-ai/prd-taskmaster` plugin.
...
Skip: generating a new PRD (use `/prd-taskmaster`), executing tasks (use
