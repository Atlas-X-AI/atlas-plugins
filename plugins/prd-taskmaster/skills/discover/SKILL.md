...
1. Call `mcp__plugin_prd_taskmaster_prd_taskmaster__check_gate(target_phase="DISCOVER")`.
...
1. Call `mcp__plugin_prd_taskmaster_prd_taskmaster__advance_phase(next_phase="GENERATE")`.
